...
/*-------------------------------------------------------------------*/
    public int[] getItemNodeIndices(boolean increment) {
        ...
        int[] dupeArray = itemNodeIndices.clone();
...
/*-------------------------------------------------------------------*/
    public Waypoint[] getItemNodeWaypoints() {
        ...
        return itemNodeWaypoints.clone();
    }
