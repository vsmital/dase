...
/*-------------------------------------------------------------------*/
     ...
     *	will run for */
/*-------------------------------------------------------------------*/
    public GANNManager(int i, int hl, int hn, int o, int trans, double resp, int pop, double cRate, double mRate, double maxPerturb, int nElite,
            int nEliteCopies, int updatesPerGen, int simTime) {
