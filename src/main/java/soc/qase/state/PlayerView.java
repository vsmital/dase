...
/*-------------------------------------------------------------------*/
    public void merge(PlayerView playerView) {
        ...
        if (viewOffset == null) viewOffset = playerView.viewOffset;
        else viewOffset.merge(playerView.viewOffset);
        if (viewAngles == null) viewAngles = playerView.viewAngles;
        else viewAngles.merge(playerView.viewAngles);
        if (kickAngles == null) kickAngles = playerView.kickAngles;
        else kickAngles.merge(playerView.kickAngles);
    }
}
