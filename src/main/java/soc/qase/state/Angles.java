...
/*-------------------------------------------------------------------*/
    public void getBytes(byte[] moveBytes, int offset) {
        Utils.shortToByteArray((short) Math.round(pitch * 65535.0f / 360.0f), moveBytes, offset + 1);
        Utils.shortToByteArray((short) Math.round(yaw * 65535.0f / 360.0f), moveBytes, offset + 3);
        Utils.shortToByteArray((short) Math.round(roll * 65535.0f / 360.0f), moveBytes, offset + 5);
    }
