...
/*-------------------------------------------------------------------*/
    public void merge(Player player) {
        ...
        if (playerView == null) playerView = player.playerView;
        else playerView.merge(player.playerView);
        if (playerMove == null) playerMove = player.playerMove;
        else playerMove.merge(player.playerMove, isUnderWater());
        ...
        if (playerStatus == null) {
            ...
            playerGun.merge(player.playerGun,
                    playerStatus.getStatus(PlayerStatus.AMMO) != Integer.MIN_VALUE && playerStatus.getStatus(PlayerStatus.AMMO) < player.getPlayerStatus()
                            .getStatus(PlayerStatus.AMMO));
