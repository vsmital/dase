...
/*-------------------------------------------------------------------*/
    private boolean readBSPLumps() {
        ...
        bspLumps[BSPHeader.VERTICES] = vertexLump = new BSPVertexLump(lumpData, bspHeader.getOffset(BSPHeader.VERTICES),
                bspHeader.getLength(BSPHeader.VERTICES));
        ...
        bspLumps[BSPHeader.LEAF_FACE_TABLE] = leafFaceLump = new BSPLeafFaceLump(lumpData, bspHeader.getOffset(BSPHeader.LEAF_FACE_TABLE),
                bspHeader.getLength(BSPHeader.LEAF_FACE_TABLE));
        bspLumps[BSPHeader.FACE_EDGE_TABLE] = faceEdgeLump = new BSPFaceEdgeLump(lumpData, bspHeader.getOffset(BSPHeader.FACE_EDGE_TABLE),
                bspHeader.getLength(BSPHeader.FACE_EDGE_TABLE));
        ...
        bspLumps[BSPHeader.BRUSH_SIDES] = brushSideLump = new BSPBrushSideLump(lumpData, bspHeader.getOffset(BSPHeader.BRUSH_SIDES),
                bspHeader.getLength(BSPHeader.BRUSH_SIDES));
        bspLumps[BSPHeader.LEAF_BRUSH_TABLE] = leafBrushLump = new BSPLeafBrushLump(lumpData, bspHeader.getOffset(BSPHeader.LEAF_BRUSH_TABLE),
                bspHeader.getLength(BSPHeader.LEAF_BRUSH_TABLE));

        bspLumps[BSPHeader.ENTITIES] = entitiesLump = new BSPEntityLump(lumpData, bspHeader.getOffset(BSPHeader.ENTITIES),
                bspHeader.getLength(BSPHeader.ENTITIES), modelLump.models);
