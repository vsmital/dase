...
/*-------------------------------------------------------------------*/
     ...
     *	@param trackInv if true, the agent will manually track its inventory */
/*-------------------------------------------------------------------*/
    public MatLabObserverBot(String botName, String botSkin, int recvRate, int msgLevel, int fov, int hand, String password, boolean highThreadSafety,
            int mlParams, boolean trackInv) {
