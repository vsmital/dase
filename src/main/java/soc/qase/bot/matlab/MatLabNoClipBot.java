...
/*-------------------------------------------------------------------*/
     ...
     *	@param trackInv if true, the agent will manually track its inventory */
/*-------------------------------------------------------------------*/
    public MatLabNoClipBot(String botName, String botSkin, Vector3f initialPosition, String password, boolean highThreadSafety, int mlParams,
            boolean trackInv) {
...
/*-------------------------------------------------------------------*/
     ...
     *	@param trackInv if true, the agent will manually track its inventory */
/*-------------------------------------------------------------------*/
    public MatLabNoClipBot(String botName, String botSkin, Vector3f initialPosition, int recvRate, int msgLevel, int fov, int hand, String password,
            boolean highThreadSafety, int mlParams, boolean trackInv) {
