...
/*-------------------------------------------------------------------*/
     ...
     *	@param trackInv if true, the agent will manually track its inventory */
/*-------------------------------------------------------------------*/
    public MatLabGeneralNoClipBot(String botName, String botSkin, Vector3f initialPosition, int recvRate, int msgLevel, int fov, int hand, String password,
            boolean highThreadSafety, boolean trackInv) {
        super((botName == null ? "MatLabGeneralNoClipBot" : botName), botSkin, initialPosition, recvRate, msgLevel, fov, hand, password, highThreadSafety, 0,
                trackInv);
    }
