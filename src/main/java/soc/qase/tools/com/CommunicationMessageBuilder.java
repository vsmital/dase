...
public class CommunicationMessageBuilder {
    ...
    private static final String FOV_MESSAGE_SNIPPET = "fov" + KEY_VALUE_DELIMITER + "90";
    private static final String MSG_MESSAGE_SNIPPET = "msg" + KEY_VALUE_DELIMITER + "1";
    ...
    private static final String RATE_MESSAGE_SNIPPET = "rate" + KEY_VALUE_DELIMITER + "30000";
    private static final String TEAM_MESSAGE_SNIPPET = "team" + KEY_VALUE_DELIMITER + "4";
    private static final String NAME_MESSAGE_SNIPPET = "name" + KEY_VALUE_DELIMITER + "VojtBot";
    private static final String MODELNAME_MESSAGE_SNIPPET = "modelname" + KEY_VALUE_DELIMITER + "models/global/m_hiro.dkm";
    private static final String SKINNAME_MESSAGE_SNIPPET = "skinname" + KEY_VALUE_DELIMITER + "skins/hiro_bod_1.wal";
    ...
    public static String buildConnectMessage(final int clientID, final String challengeNumber) {
        ...
        result = result + KEY_VALUE_ENTRY_DELIMITER + FOV_MESSAGE_SNIPPET;
        result = result + KEY_VALUE_ENTRY_DELIMITER + MSG_MESSAGE_SNIPPET;
        ...
        result = result + KEY_VALUE_ENTRY_DELIMITER + RATE_MESSAGE_SNIPPET;
        result = result + KEY_VALUE_ENTRY_DELIMITER + TEAM_MESSAGE_SNIPPET;
        result = result + KEY_VALUE_ENTRY_DELIMITER + NAME_MESSAGE_SNIPPET;
        result = result + KEY_VALUE_ENTRY_DELIMITER + MODELNAME_MESSAGE_SNIPPET;
        result = result + KEY_VALUE_ENTRY_DELIMITER + SKINNAME_MESSAGE_SNIPPET;
