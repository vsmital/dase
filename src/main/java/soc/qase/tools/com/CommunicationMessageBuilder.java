...
public class CommunicationMessageBuilder {
    ...
    private static final String DAIKATANA_VERSION_MESSAGE_SNIPPET = "version" + KEY_VALUE_DELIMITER + "Daikatana v1.3 for x86. Built Mar  6 2016 at 21:14:31";
    ...
    private static final String CL_AUTOWEAPONSWITCH_MESSAGE_SNIPPET = "cl_autowweaponswitch" + KEY_VALUE_DELIMITER + "0";
    ...
    private static final String SPECTATOR_MESSAGE_SNIPPET = "spectator" + KEY_VALUE_DELIMITER + "0";
    private static final String CL_POWERUP_SOUNDS_SNIPPET = "cl_powerup_sounds" + KEY_VALUE_DELIMITER + "3";
    ...
    public static String buildConnectMessage(final int clientID, final String challengeNumber, final User user) {
        ...
        result = result + KEY_VALUE_ENTRY_DELIMITER + SPECTATOR_MESSAGE_SNIPPET;
        ...
        result = result + KEY_VALUE_ENTRY_DELIMITER + CL_POWERUP_SOUNDS_SNIPPET;
